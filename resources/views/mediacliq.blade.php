...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                <div class="title m-b-md">MediaCliQ</div>
                <p class="m-b-md">This is a URL shortener. Please insert a URL in the form below.</p>

                <form method="POST" action="convert-url" target="_blank">
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="url" class="form-control required" id="exampleURL" name="exampleURL" placeholder="Enter URL">
                        </div>
                    </div>
